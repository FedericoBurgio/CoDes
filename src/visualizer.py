...
class Solver:
    ...
    def create_circular_traj(self, center=np.array([.0, .0, 1.0]), radius=0.5, period=2, z_height=1.0, dt=1e-3):
...
#TODO add metrics, add integration function, add stiff/damped mass
